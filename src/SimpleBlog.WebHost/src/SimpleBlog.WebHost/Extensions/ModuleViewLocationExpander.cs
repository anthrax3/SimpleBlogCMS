...
namespace SimpleBlog.WebHost.Extensions
{
    public class ModuleViewLocationExpander : IViewLocationExpander
    {
        ...
        public IEnumerable<string> ExpandViewLocations(ViewLocationExpanderContext context, IEnumerable<string> viewLocations)
        {
            if (context.Values.ContainsKey(_moduleKey))
            {
                ...
                if (!string.IsNullOrWhiteSpace(module))
                {
                    ...
                    {
                    "/Modules/SimpleBlog.Modules." + module + "/Views/{1}/{0}.cshtml",
                    "/Modules/SimpleBlog.Modules." + module + "/Views/Shared/{0}.cshtml"
                    };
        ...
        public void PopulateValues(ViewLocationExpanderContext context)
        {
            ...
            var moduleName = controller.Split('.')[5];
